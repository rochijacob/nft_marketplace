...
const DetailsHeader = ({data, navigation}) => (
  <View style={{width: '100%', height: 373}}>
    ...
    <CircleButton imageUrl={assets.left} handlePress={() => navigation.goBack()} left={15} top={StatusBar.currentHeight + 10} />
    <CircleButton imageUrl={assets.heart} handlePress={() => navigation.goBack()} right={15} top={StatusBar.currentHeight + 10} />
  </View>
)
      ...
      ListHeaderComponent={() => (
        <React.Fragment>
          ...
          <View style={{
            ...
            {data.bids.length > 0 && 
            <Text style={{fontSize: SIZES.large, fontFamily: FONTS.semiBold, color: COLORS.primary}}>Current Bids</Text>
            }     
          </View>
        </React.Fragment>
      )}
